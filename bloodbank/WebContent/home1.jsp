...
<b><p p style="color:red;font-size:30px;">Welcome,<%=request.getAttribute("username")%></p></b>
</head>
<style>
body{
   height:100%;
...
<div align="left">
WELCOME,<%=request.getAttribute("username")%></div>
<div align="right">
<p><a href="home.jsp" ><h2>logout</h2></a></p></div>
